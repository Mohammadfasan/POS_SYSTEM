...
//
// These statuses reserve returnable quantity.
//
// Example:
//
// Original quantity = 5
  ...
  return runSerializableTransaction(
    async (tx) => {
      ...
      for (
        ...
        // ==========================================
        // RETURNING ALL REMAINING
        //
        // Use residual values to avoid money rounding
        // problems.
        // ==========================================
      ...
      await createAuditLog({
        ...
        description:
          `Return ${saleReturn.returnNumber} requested for sale ${sale.saleNumber}`,
...
export const getReturnByNumber = async ({
  user,
  returnNumber,
}) => {
  ...
  await runSerializableTransaction(
    async (tx) => {
      ...
      await createAuditLog({
        ...
        description:
          `Return ${saleReturn.returnNumber} approved`,
  ...
  await runSerializableTransaction(
    async (tx) => {
      ...
      await createAuditLog({
        ...
        description:
          `Return ${saleReturn.returnNumber} rejected`,
  ...
  await runSerializableTransaction(
    async (tx) => {
      ...
      await createAuditLog({
        ...
        description:
          `Return ${saleReturn.returnNumber} cancelled`,
...
export const processReturnRefund = async ({
  ...
  return runSerializableTransaction(
    async (tx) => {
      ...
      // REFUND_COMPLETED
      //
      // CRITICAL because money leaves POS.
      // ============================================
      ...
      await createAuditLog({
        ...
        description:
          `Refund completed for return ${saleReturn.returnNumber}`,
      ...
      await createAuditLog({
        ...
        description:
          `Return ${saleReturn.returnNumber} completed`,
